...
export const TRANSLATIONS_CZ = {
  ...
  log_night_bullet_continue_sniper: `, ale kulka letí dál, protože ${card('Mirror', 'Zrcadlo')} {target} neodráží střely ${card('Sniper', 'Snipera')},`,
  log_night_bullet_continue_matrix: `, ale kulka letí dál, protože ${card('Mirror', 'Zrcadlo')} {target} nezastavuje střely ${card('Matrix', 'Matrixe')},`,
  log_night_bullet_continue_mud: `, ale kulka letí dál, protože ${card('Mirror', 'Zrcadlo')} {target} bylo zablácené,`,
  ...
  public_report_day_player_left: 'a naši hru opouští {name}.',
  public_report_day_ropewalker_lost: `${card('RopeWalker', 'Provazochodec {num}')} ztracen.`,
  public_report_day_cloudwalker_lost: `${card('CloudWalker', 'Mrákošlap {num}')} ztracen.`,
  public_report_day_kevlar_lost: `${card('KevlarVest', 'Kevlar {num}')} zničen.`,
  public_report_day_immunity_lost: `${card('Immunity', 'Imunita {num}')} spotřebována.`,

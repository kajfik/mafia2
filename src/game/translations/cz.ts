...
export const TRANSLATIONS_CZ = {
  ...
  log_tunnel_atheist: '{cardLabel} {player} chtěl použít tunel na hráče {target}, ale je to Ateista.',
  ...
  public_report_leech_cloudwalker: 'Pijavice získává Mrákošlapa {num}.',
  log_night_leech_cloudwalker: '{cardLabel} {player} získává Mrákošlapa {num}.',

  // Sand
  wake_up_sand: 'Probouzí se {role}. Koho chce posypat pískem?',
  log_action_sand: '{cardLabel} {player} posypal pískem hráče {target}.',
  log_action_sand_fail: '{cardLabel} {player} chtěl použít Písek na hráče {target}, ale ten má Plynovou masku.',
  public_report_sand: '{name} má písek v očích.',
  public_report_sand_saved: 'Plynová maska uchránila hráče před Pískem.',

  // Cobra
  wake_up_cobra: 'Probouzí se {role}. Koho chce uštknout?',
  log_action_cobra: '{name} byl uštknut.',
  public_report_cobra_cloudwalker: 'Kobra požírá Pijavici a získává Mrákošlapa {num}.',
  log_night_cobra_cloudwalker: '{cardLabel} {player} požírá Pijavici a získává Mrákošlapa {num}.',
  ...
  log_sock_result_cloudwalker: 'Hráč {name} ztratil Mrákošlapa. ',
  log_sock_result_death: 'Hráč {name} opouští hru. ',
  public_report_sock_used: 'Ponožka byla hozena mezi dva hráče. ',
  ...
  public_report_sock_first_doctor: 'Prvního hráče zachránil Doktor',
  public_report_sock_first_cloudwalker: 'První hráč ztratil Mrákošlapa',
  public_report_sock_first_death: 'První hráč, {name}, opouští hru',
  ...
  public_report_sock_second_doctor: ' a druhého zachránil Doktor.',
  public_report_sock_second_cloudwalker: ' a druhý hráč ztratil Mrákošlapa.',
  public_report_sock_second_death: ' a hru opouští {name}.',
  ...
  log_doctor_fail: '{cardLabel} {player} chtěl vyléčit {target}, ale cíl nebude vyléčen, protože Doktor působí sám proti Mafii.',
  ...
  log_night_matrix_bullet_summary: 'Počet kulek, které Matrix {player} zachytil tuto noc: {count}.',
  ...
  // Mafia/Shooting
  wake_up_mafia_aim: 'Probouzí se {role}. Na koho míří?',
  log_mafia_jailed: '{cardLabel} {player} je ve vězení, takže Mafie nevystřelí.',
  log_mafia_no_consensus: 'Mafiáni se neshodli na cíli, takže té noci nikdo nestřílel.',
  ...
  log_day_vest_hit: '{target} ztrácí Kevlar {num}.',
  log_day_ropewalker_lost: '{target} ztrácí Provazochodce {num}.',
  log_day_immunity_lost: '{target} ztrácí Imunitu {num}.',
  log_day_cloudwalker_lost: '{target} ztrácí Mrákošlapa {num}.',
  log_day_death: '{target} umírá.',

  // Morning Report
  public_report_default: 'Městečko Palermo se probouzí.',
  public_report_matrix: 'Tuto noc Matrix použil svou funkci. Počet kulek, které zachytil: {count}.',
  public_report_cloudwalker_gain: '{cardLabel} získává Mrákošlapa {num}.',
  public_report_glazier_mirror: 'Sklenář vytváří Zrcadlo {num}.',
  log_night_cloudwalker_gain: '{cardLabel} {player} získává Mrákošlapa {num}.',
  log_night_glazier_mirror: '{cardLabel} {player} vytváří Zrcadlo {num}.',
  
  
  // Bullet Report Fragments
  public_report_bullet_dead_target: ', ale zasáhla mrtvého hráče.',
  public_report_bullet_start: 'Padl výstřel',
  public_report_bullet_matrix_catch: ' a Matrix ho zachytil.',
  public_report_bullet_magnet: ', byl přitáhnut Magnetem',
  public_report_bullet_magnet_dead: ', a přitáhl kulku k mrtvému hráči.',
  ...
  public_report_bullet_slime: ' a kulka sklouzla po slině.',
  public_report_bullet_al_capone: ', ale Al Capone zneutralizoval hrozbu.',
  public_report_bullet_doctor: ', ale Doktor zneutralizoval kulku.',
  public_report_bullet_mirror_break: ', prasklo Zrcadlo {num}',
  public_report_bullet_return: ', kulka se vrátila',
  public_report_bullet_continue: ', kulka letí dál',
  public_report_bullet_vest_loss: ' a Kevlar {num} byl zničen.',
  public_report_bullet_cloudwalker_loss: ' a zemřel Mrákošlap {num}.',
  public_report_bullet_death: ' a {name} umírá.',
  ...
  log_night_bullet_dead_target: ' Zasáhla mrtvého hráče {target}.',
  log_night_bullet_matrix_catch: ' a Matrix {target} ho zachytil.',
  log_night_bullet_magnet_initial: 'Kulka byla přitáhnuta Magnetem k hráči {target}',
  log_night_bullet_magnet: ', byla přitáhnuta Magnetem k hráči {target}',
  log_night_bullet_magnet_dead: ' a zasáhla mrtvého hráče {target} (efekt Magnetu).',
  ...
  log_night_bullet_slime_initial: 'Kulka sklouzla po slině {target}.',
  log_night_bullet_slime: ' a sklouzla po slině {target}.',
  log_night_bullet_al_capone_initial: 'Al Capone {target} neutralizuje kulku.',
  log_night_bullet_al_capone: ' a Al Capone {target} ji neutralizuje.',
  log_night_bullet_doctor_initial: 'Doktor zachránil hráče {target}.',
  log_night_bullet_doctor: ' a hráč {target} byl vyléčen Doktorem.',
  log_night_bullet_mirror_break_initial: 'Kulka rozbíjí Zrcadlo {num} u hráče {target}',
  log_night_bullet_mirror_break: ', u hráče {target} prasklo Zrcadlo {num}',
  log_night_bullet_return: ', kulka se vrátila k {target}',
  log_night_bullet_continue_sniper: ', ale kulka letí dál, protože Zrcadlo {target} neodráží střely Snipera,',
  log_night_bullet_continue_matrix: ', ale kulka letí dál, protože Zrcadlo {target} nezastavuje střely Matrixe,',
  log_night_bullet_continue_mud: ', ale kulka letí dál, protože Zrcadlo {target} bylo zablácené,',
  log_night_bullet_vest_loss_initial: 'Kulka ničí Kevlar {num} hráče {target}.',
  log_night_bullet_vest_loss: ' a {target} ztrácí Kevlar {num}.',
  log_night_bullet_cloudwalker_loss_initial: 'Kulka bere Mrákošlapa {num} hráči {target}.',
  log_night_bullet_cloudwalker_loss: ' a {target} ztrácí Mrákošlapa {num}.',
  log_night_bullet_death_initial: 'Kulka zabíjí hráče {name}.',
  log_night_bullet_death: ' a {name} umírá.',
  log_night_bullet_gandalf_from_horse: ' Gandalf {gandalf} získává Mrákošlapa {num} (ztráta Kusu Koňa {horse}: {lost}).',
  log_night_bullet_horsepiece_from_gandalf: ' Kus Koňa {horse} získává Mrákošlapa {num} (ztráta Gandalfa {gandalf}: {lost}).',
  ...
  public_report_day_player_left: '{name} opouští naši hru.',
  public_report_day_ropewalker_lost: 'Provazochodec {num} ztracen.',
  public_report_day_cloudwalker_lost: 'Mrákošlap {num} ztracen.',
  public_report_day_kevlar_lost: 'Kevlar {num} zničen.',
  public_report_day_immunity_lost: 'Imunita {num} spotřebována.',
  ...
  log_day_shot: '{actor} postřelil {target}.',
  log_day_bomb: 'Terorista {player} odpaluje bombu!',
  log_day_astronomer: 'Astronom {player} ukončuje den.',
  log_day_communist: 'Komunista {player} zavádí rovnost.',
  log_day_mass_murderer_trigger: 'Masový Vrah {target} sahá po zbrani před rozsudkem.',
  log_day_mass_murderer_shot: 'Masový Vrah {player} zabíjí {target}.',

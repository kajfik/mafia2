  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        blocks: [
          { kind: 'paragraph', text: `Pod kóniec każdej trzeci nocy (zaczynajónc od drugi) se budzi ${card('Spyglass', 'Luneta')}, aby wiedziała, kierzi gracze se nie obudzili.` },
...
export const TRANSLATIONS_PO_NASZYMU = {
  ...
  // Card descriptions
  card_description_AlCapone: 'Al Capone jako ojciec chrzestny Mafii je imunni na jeji ataki. Ochróna ta działo na bezpostrzedni strzał Mafii aj na kule przekierowane przez Tunel, ale nie chróni przed kulóm przekierowanóm przez Magnet albo Zwierciadło.',
  card_description_Anarchist: 'Anarchista może roz za gre w dziyń użyć swojóm zdolność a powiedzieć "I shoot you baby!", po czym strzilo do osoby, kieróm se wybiere.',
  card_description_Astronomer: 'Astronom może roz za gre w dziyń użyć swojóm zdolność a powiedzieć "Noc!", po czym se hned kóńczy dziyń, aj jak prawie trwo głosowani.',
  card_description_Atheist: 'Tunel zrobiony z Maga na Ateiste nie funguje. Prowadzóncy nie mówi Magowi, że zrobił tunel na Ateiste.',
  ...
  card_description_Cobra: 'Kobra każdóm parzystóm noc pokazuje grocza, kiery podle ni mo Pijawice. Jeśli se trefi, pod kóniec nocy dostanie Mrakoszlapa a zjy Pijawice (gracz z tóm kartóm straci swoje zdolności).',
  card_description_Communist: 'Kómunista może roz za gre w dziyń użyć swojóm zdolność a powiedzieć "Obywatele, w tej rundzie my sóm wszyscy równi", po czym anuluje na jedyn dziyń zdolności Mecziara, Kovacza, Ducha Bobo a Soudce.',
  ...
  card_description_GhostBobo: 'Duch Bobo każdóm parzystóm noc pokazuje grocza, kiery w nastympny dziyń bydzie mioł zakaz mówiynio (zakaz może zruszyć jyny Kómunista). Jeśli mo oskarżóny gracz zakaz mówiynia, wybiyro se osobe, kiero go bydzie brónić tłumaczónc jego miny a gesty.',
  card_description_Gravedigger: 'Grabarz może roz za gre w nocy wykopać groby do Mrakoszlapów, a pod kóniec nocy ich dostanie tela, wiela ich tej nocy stracili inni grocze.',
  ...
  card_description_Judge: 'Soudce każdej parzystej nocy pokazuje gracza, kiery w nastympny dziyń bydzie mioł zakaz głosowanio. Kómunista może tyn zakaz zruszyć.',
  card_description_KevlarVest: 'Karta obrónno na przipadek trefiynio kulóm.',
  card_description_Kovac: 'Kovacz zmniyjszo liczbe głosów za jego śmiercióm o 1. Kómunista może tyn bonus zruszyć.',
  card_description_Leech: 'Pijawica każdej nocy pokazuje gracza, do kierego se przysyso. Jeśli tyn gracz straci w nocy Mrakoszlapa albo zginie, Pijawica dostanie Mrakoszlapa. Pijawica może być zjedzóno Kobróm.',
  ...
  card_description_MassMurderer: 'Jeśli zostanie Masowy Zabijak skazany na szubienice, strzilo do wszystkich, kierzi na niego głosowali. Dzieje sie tak ino przi piyrszym skazaniu.',
  ...
  card_description_Meciar: 'W głosowaniu se jego głos liczy podwójnie. Kómunista może tyn bonus zruszyć.',
  ...
  card_description_SwampMonster: 'Jożin z Bażin może trzi razy za gre pokozać w nocy gracza, kierymu poplami Zwierciadło. Kula rozbijo brudne Zwierciadło, a leci dali. Jożin może użyć swojóm zdolność wiyncej razy w jednóm noc. Jeśli mo Jożin też karte Mafiana, Snipera albo Szilenego Strzelca, może poplamić Zwierciadło jyny dwa razy.',
  card_description_Terrorist: 'Terrorysta może roz za gre w dziyń użyć swojóm zdolność a powiedzieć "Bómba!", po czym strzilo do wszystkich graczy, aj do siebie.',
  ...
  // Spyglass
  wake_up_spyglass: 'Budzi se Luneta. Dowiedziała se, gdo se nie obudził tej nocy?',
  spyglass_reveal_intro: 'Tej nocy se nie obudzili: {names}.',
  spyglass_reveal_none: 'Tej nocy se obudzili wszyscy.',
  ...
  warn_communist_unavailable: 'Kómunista uż nimoże użyć swojóm zdolność.',
  warn_communist_day_only: 'Kómunista działo jny w dziyń.',
  ...
  log_day_communist: `${card('Communist', 'Kómunista')} {player} wprowadzo równość.`,

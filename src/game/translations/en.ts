...
export const TRANSLATIONS_EN = {
  ...
  log_tunnel_atheist: '{cardLabel} {player} attempted to use a tunnel on player {target}, but they are an Atheist.',
  ...
  public_report_leech_cloudwalker: 'Leech gains CloudWalker {num}.',
  log_night_leech_cloudwalker: '{cardLabel} {player} gains CloudWalker {num}.',

  // Sand
  wake_up_sand: '{role} wakes up. Who do they want to throw sand at?',
  log_action_sand: '{cardLabel} {player} threw sand at player {target}.',
  log_action_sand_fail: '{cardLabel} {player} attempted to use Sand on player {target}, but they possess a Gas Mask.',
  public_report_sand: '{name} has sand in their eyes.',
  public_report_sand_saved: 'Gas Mask saved the player from Sand.',

  // Cobra
  wake_up_cobra: '{role} wakes up. Who do they want to bite?',
  log_action_cobra: '{name} was bitten.',
  public_report_cobra_cloudwalker: 'Cobra devours the Leech and gains CloudWalker {num}.',
  log_night_cobra_cloudwalker: '{cardLabel} {player} devours the Leech and gains CloudWalker {num}.',
  ...
  log_sock_result_doctor: 'Doctor saved player {name}. ',
  log_sock_result_cloudwalker: 'Player {name} lost a CloudWalker. ',
  log_sock_result_death: 'Player {name} leaves the game. ',
  public_report_sock_used: 'A Sock was thrown between two players. ',
  ...
  public_report_sock_first_doctor: 'The first player was saved by a Doctor',
  public_report_sock_first_cloudwalker: 'The first player lost a CloudWalker',
  public_report_sock_first_death: 'The first player, {name}, leaves the game',
  ...
  public_report_sock_second_doctor: ', and the second was saved by a Doctor.',
  public_report_sock_second_cloudwalker: ', and the second player lost a CloudWalker.',
  public_report_sock_second_death: ', and {name} leaves the game.',
  ...
  log_doctor_fail: '{cardLabel} {player} attempted to heal {target}, but failed because the Doctor works alone against the Mafia.',
  ...
  log_night_matrix_bullet_summary: 'Number of bullets Matrix {player} intercepted tonight: {count}.',
  ...
  // Mafia/Shooting
  wake_up_mafia_aim: '{role} wakes up. Who do they aim at?',
  log_mafia_jailed: '{cardLabel} {player} is in prison, so the Mafia will not take a shot.',
  log_mafia_no_consensus: 'Mafiosi did not agree on a target, so no one shot tonight.',
  ...
  log_day_vest_hit: '{target} loses Kevlar Vest {num}.',
  log_day_ropewalker_lost: '{target} loses RopeWalker {num}.',
  log_day_immunity_lost: '{target} loses Immunity {num}.',
  log_day_cloudwalker_lost: '{target} loses CloudWalker {num}.',
  log_day_death: '{target} dies.',

  // Morning Report
  public_report_default: 'The town of Palermo wakes up.',
  public_report_matrix: 'Matrix used his function tonight. Number of bullets intercepted: {count}.',
  public_report_cloudwalker_gain: '{cardLabel} gains CloudWalker {num}.',
  public_report_glazier_mirror: 'Glazier creates Mirror {num}.',
  log_night_cloudwalker_gain: '{cardLabel} {player} gains CloudWalker {num}.',
  log_night_glazier_mirror: '{cardLabel} {player} creates Mirror {num}.',
  
  
  // Bullet Report Fragments
  public_report_bullet_dead_target: ', but hit a dead player.',
  public_report_bullet_start: 'A shot was fired',
  public_report_bullet_matrix_catch: ' and Matrix caught it.',
  public_report_bullet_magnet: ', was attracted by the Magnet',
  public_report_bullet_magnet_dead: ', attracting the bullet to a dead player.',
  ...
  public_report_bullet_slime: ' and the bullet slid off the slime.',
  public_report_bullet_al_capone: ', but Al Capone neutralized the threat.',
  public_report_bullet_doctor: ', but the Doctor neutralized the bullet.',
  public_report_bullet_mirror_break: ', Mirror {num} shattered',
  public_report_bullet_return: ', the bullet returned',
  public_report_bullet_continue: ', the bullet flies on',
  public_report_bullet_vest_loss: ' and Kevlar Vest {num} was destroyed.',
  public_report_bullet_cloudwalker_loss: ' and CloudWalker {num} died.',
  public_report_bullet_death: ' and {name} dies.',
  ...
  log_night_bullet_dead_target: ' It hits dead player {target}.',
  log_night_bullet_matrix_catch: ' and Matrix {target} caught it.',
  log_night_bullet_magnet_initial: 'The bullet was attracted by the Magnet to player {target}',
  log_night_bullet_magnet: ', was attracted by the Magnet to player {target}',
  log_night_bullet_magnet_dead: ' and hits dead player {target} (Magnet effect).',
  ...
  log_night_bullet_slime_initial: 'The bullet slides off the slime on {target}.',
  log_night_bullet_slime: ' and slides off the slime on {target}.',
  log_night_bullet_al_capone_initial: 'Al Capone {target} neutralizes the bullet.',
  log_night_bullet_al_capone: ' and Al Capone {target} neutralizes it.',
  log_night_bullet_doctor_initial: 'The Doctor healed player {target}.',
  log_night_bullet_doctor: ' and player {target} was healed by the Doctor.',
  log_night_bullet_mirror_break_initial: 'The bullet shatters Mirror {num} on player {target}',
  log_night_bullet_mirror_break: ', Mirror {num} on player {target} shattered',
  log_night_bullet_return: ', the bullet returned to {target}',
  log_night_bullet_continue_sniper: ', but the bullet flies on because the Mirror {target} does not reflect Sniper shots,',
  log_night_bullet_continue_matrix: ', but the bullet flies on because the Mirror {target} does not stop Matrix shots,',
  log_night_bullet_continue_mud: ', but the bullet flies on because the Mirror {target} was muddy,',
  log_night_bullet_vest_loss_initial: 'The bullet destroys Kevlar Vest {num} of player {target}.',
  log_night_bullet_vest_loss: ' and {target} loses Kevlar Vest {num}.',
  log_night_bullet_cloudwalker_loss_initial: 'The bullet takes CloudWalker {num} from player {target}.',
  log_night_bullet_cloudwalker_loss: ' and {target} loses CloudWalker {num}.',
  log_night_bullet_death_initial: 'The bullet kills player {name}.',
  log_night_bullet_death: ' and {name} dies.',
  log_night_bullet_gandalf_from_horse: ' Gandalf {gandalf} gains CloudWalker {num} (loss of Horse Piece {horse}: {lost}).',
  log_night_bullet_horsepiece_from_gandalf: ' Horse Piece {horse} gains CloudWalker {num} (loss of Gandalf {gandalf}: {lost}).',
  ...
  public_report_day_ropewalker_lost: 'RopeWalker {num} lost.',
  public_report_day_cloudwalker_lost: 'CloudWalker {num} lost.',
  public_report_day_kevlar_lost: 'Kevlar Vest {num} destroyed.',
  public_report_day_immunity_lost: 'Immunity {num} used.',
  ...
  log_day_shot: '{actor} shot {target}.',
  log_day_bomb: 'Terrorist {player} detonates the bomb!',
  log_day_astronomer: 'Astronomer {player} ends the day.',
  log_day_communist: 'Communist {player} enforces equality.',
  log_day_mass_murderer_trigger: 'Mass Murderer {target} reaches for a weapon before the sentence.',
  log_day_mass_murderer_shot: 'Mass Murderer {player} kills {target}.',

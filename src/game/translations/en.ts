...
export const TRANSLATIONS_EN = {
  ...
  log_night_bullet_continue_sniper: `, but the bullet flies on because ${card('Mirror', 'the Mirror')} {target} does not reflect ${card('Sniper')} shots,`,
  log_night_bullet_continue_matrix: `, but the bullet flies on because ${card('Mirror', 'the Mirror')} {target} does not stop ${card('Matrix')} shots,`,
  log_night_bullet_continue_mud: `, but the bullet flies on because ${card('Mirror', 'the Mirror')} {target} was muddy,`,
  ...
  public_report_day_player_left: 'and {name} leaves our game.',
  public_report_day_ropewalker_lost: `${card('RopeWalker', 'RopeWalker {num}')} lost.`,
  public_report_day_cloudwalker_lost: `${card('CloudWalker', 'CloudWalker {num}')} lost.`,
  public_report_day_kevlar_lost: `${card('KevlarVest', 'Kevlar Vest {num}')} destroyed.`,
  public_report_day_immunity_lost: `${card('Immunity', 'Immunity {num}')} used.`,

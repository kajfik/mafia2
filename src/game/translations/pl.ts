...
export const TRANSLATIONS_PL = {
  ...
  log_night_bullet_continue_sniper: `, lecz pocisk leci dalej, gdyż ${card('Mirror', 'Zwierciadło')} {target} nie odbija strzałów ${card('Sniper', 'Snajpera')},`,
  log_night_bullet_continue_matrix: `, lecz pocisk leci dalej, gdyż ${card('Mirror', 'Zwierciadło')} {target} nie zatrzymuje strzałów ${card('Matrix', 'Matrixa')},`,
  log_night_bullet_continue_mud: `, lecz pocisk leci dalej, gdyż ${card('Mirror', 'Zwierciadło')} {target} było zabłocone,`,
  ...
  public_report_day_player_left: 'a naszą grę opuszcza {name}.',
